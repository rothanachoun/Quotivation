...
for (const [index, quote] of quotes.entries()) {
  ...
  quoteStatements.push(`INSERT INTO quotes (
    id, topic_id, type, text, decoration, author, style, segments,
    ...
    ${sqlText(quote.decoration ?? 'soft')}, ${sqlNullableText(quote.author?.name)}, ${sqlJson(quote.style)},
...
const sql = [
  ...
  `CREATE TABLE quotes (id TEXT PRIMARY KEY, topic_id TEXT NOT NULL, type TEXT NOT NULL, text TEXT NOT NULL,
    decoration TEXT NOT NULL DEFAULT 'soft', author TEXT, style TEXT, segments TEXT,
